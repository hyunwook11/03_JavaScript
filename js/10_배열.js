...
1) 합계 출력 
1) 평균 출력 
1) 짝수(0, 2, 4) 번째 index 요소의 합계 출력 
1) 홀수(1, 3)    번째 index 요소의 합계 출력 */
function check4(){
    ...
    // 3) 평균 츨력(arr.length === 5 === 입력된 값의 개수)
...
function check6(){
    ...
    console.log("dArr : ", dArr1);
    console.log("dArr : ", dArr2);
    ...
    // 2차원 배열 인덱스 이영해서 값 대입
    // 0행 0열, 1행 02, 2행 2열 값을 *10 해서 대입
...
function check7(){
    ...
    for (let col = 0; col < arr[row].length ; col++) // 행 반복
    // 행 반복
