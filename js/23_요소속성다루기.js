...
addBtn.addEventListener("click", () =>{
    ...
    // const container = document.querySelector(".contains-3");
    ...
    /* class를 추가하여 css변경 */
    btnContainer.classList.add("test");
});
...
btns.forEach((btn) => {
    ...
    btn.addEventListener("click", () => {
        ...
        // container3가 가지고 있는 bg-로 시작하는 class 모두제거
