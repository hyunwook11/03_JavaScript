...
function nameTest(){
    ...
    // -> name-result 가 1개 밖에 ㅇ벗으므로 0번 인덱스만 선택
    const div = document.getElementsByClassName("name-result")[0];

    // 내부에 내용 작성(HTML 코드를 해석 ㅇ)
...
function cssTest(){
    ...
    for(let i=0 ; i < div.length ; i++){
        ...
        divs[i].style.alignItems = "center"; // 중심축 방향 가운데
...
.addEventListener("keydowun", function(e){
    //입력된 키를 콘솔에 출력
    // console.log(e.key);
